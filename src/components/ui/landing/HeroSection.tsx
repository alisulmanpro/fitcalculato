    ...
    <>
      <section className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant mb-10">
          Free, science-backed calculators for everything from BMI to Zone 2 heart rate and GLP-1 tracking. Pick a tool, enter your numbers, get instant results.
        </p>
        <div className="relative max-w-2xl mx-auto group shadow-lg shadow-surface-variant/50 rounded-full cursor-pointer" onClick={() => setIsSearchOpen(true)}>
          ...
          <input 
            type="text" 
            placeholder="Search calculators... (e.g. BMI, calories, VO2 max)" 
