...
export default function AuthorWidget() {
  return (
    <div className="card card-side bg-base-200 shadow-xl p-6 md:p-8 flex flex-col md:flex-row items-start gap-6 border border-gray-100 rounded-2xl my-8 hover:scale-101">
