  ...
  return (
    <main className="grow w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-8 md:py-12">
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to FitCalculato.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to FitCalculato, accessible from <a href="https://fitcalculato.com/" rel="external nofollow noopener" target="_blank">https://fitcalculato.com/</a>.</p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: info@fitcalculato.com</p>
        </li>
        <li>
          <p>By visiting this page on our website: <a href="https://fitcalculato.com/contact" rel="external nofollow noopener" target="_blank">https://fitcalculato.com/contact</a></p>
        </li>
      </ul>
      </div>
    </main>
